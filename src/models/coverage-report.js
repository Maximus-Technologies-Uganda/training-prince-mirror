/**
 * Coverage Report Entity Model
 * Represents test coverage data for individual backend applications
 */
...
export class CoverageReport {
  ...
  /**
   * Validate the coverage report data
   */
  validate() {
    const errors = [];
  ...
  static fromJSON(json) {
    return new CoverageReport(json);
  }
