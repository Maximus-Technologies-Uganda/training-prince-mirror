...
/**
 * Syncs completed tasks to Linear for Day 0 (PRI-258)
 * Reads tasks.md for completed items (marked with [x])
 * Updates corresponding Linear issues to "Done" status
 * Usage: LINEAR_API_KEY=xxx node scripts/sync-day0-task-status.js
 */

import fs from 'fs';
import https from 'https';

const TASKS_FILE = 'specs/011-title-day-0/tasks.md';
const MAPPING_FILE = 'specs/011-title-day-0/linear-map.json';
...
async function main() {
  try {
    console.log('🚀 Syncing Day 0 (PRI-258) Tasks to Linear\n');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
